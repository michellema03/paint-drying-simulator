...
from time import *
from random import *
#import winsound #COMMENT THIS OUT if not using Windows!!
# don't forget to toggle usingWindows down in initialValues as well!
...
def initialValues(): #set initial variables
    ...
    global usingWindows
    usingWindows = False #TOGGLE THIS if not using Windows!
    ...
    #wall pics
    title1 = PhotoImage(file = "drawings/title1.gif")
    title2 = PhotoImage(file = "drawings/title2.gif")
    wall1 = PhotoImage(file = "drawings/wall1.gif")
    wall2 = PhotoImage(file = "drawings/wall2.gif")
    wall3 = PhotoImage(file = "drawings/wall3.gif")
    wall4 = PhotoImage(file = "drawings/wall4.gif")
    wall5 = PhotoImage(file = "drawings/wall5.gif")
    wall6 = PhotoImage(file = "drawings/wall6.gif")
    wall7 = PhotoImage(file = "drawings/wall7.gif")

    #bug pics
    dragonflyImage = PhotoImage(file = "drawings/dragonfly.gif")
    spiderImage = PhotoImage(file = "drawings/spider.gif")
    flyingLadybug = PhotoImage(file = "drawings/flyingLadybug.gif") #extra little thing for flying/landed ladybugs :)
    landedLadybug = PhotoImage(file = "drawings/ladybug.gif")
    deadDragonfly = PhotoImage(file = "drawings/deadDragonfly.gif")
    deadSpider = PhotoImage(file = "drawings/deadSpider.gif")
    deadLadybug = PhotoImage(file = "drawings/deadLadybug.gif")
    ...
    #other pics
    background = PhotoImage(file = "drawings/background.gif")
    fan1 = PhotoImage(file = "drawings/fan1.gif")
    fan2 = PhotoImage(file = "drawings/fan2.gif")
    fan3 = PhotoImage(file = "drawings/fan3.gif")
    fanPic = fan1
    bucketPic = PhotoImage(file = "drawings/bucket.gif")
    brushBucket = PhotoImage(file = "drawings/brushbucket.gif")
    paint1 = PhotoImage(file = "drawings/paint1.gif")
    paint2 = PhotoImage(file = "drawings/paint2.gif")
    paint3 = PhotoImage(file = "drawings/paint3.gif")
    paintPic = paint1
    coinImage = PhotoImage(file = "drawings/coin.gif")
            ...
            if 100 < event.x < 600:
                if 150 < event.y < 250: #if EASY button is clicked
                    ...
                    if usingWindows == True:
                        winsound.PlaySound("music/summer.wav", winsound.SND_ASYNC) #plays background music
                elif 300 < event.y < 400: #MEDIUM button
                    diffNum = 13000
                    if usingWindows == True:
                        winsound.PlaySound("music/entertainer.wav", winsound.SND_ASYNC) #plays background music
                elif 450 < event.y < 550: #HARD button
                    diffNum = 9000
                    if usingWindows == True:
                        winsound.PlaySound("music/bumblebee.wav", winsound.SND_ASYNC) #plays background music
